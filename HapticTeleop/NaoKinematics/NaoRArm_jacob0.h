/*! \file NaoRArm_jacob0.h
\brief C code for the Jacobian with respect to the base coordinate frame of the NaoRArm arm. 
...
<BR><BR> 
__Copyright Note__: 
  <BR>Copyright  (C) 1993-2018, by Peter I. Corke 
  <BR>Copyright  (C) 2012-2018, by Joern Malzahn 
...
/*!\fn void NaoRArm_jacob0(double J0[][6], const double* input1);
...
void NaoRArm_jacob0(Eigen::Matrix<double,6,5> &J0, std::vector<float> &thetas);
